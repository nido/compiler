...
{
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof (struct gspin, u1.arg) + sizeof(gs_t) * i) < gspin_node_size(node->u0.u0s0.code), "Bad operand in gs_set_operand");
#endif
  node->u1.arg[i] = arg;
  return;
}
...
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.data) + sizeof(int) * 2) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_bv");
#endif
...
static inline gs_void_t _gs_n (gs_t node, int n)
{
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)offsetof(struct gspin, u1.n) < gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_bv");
#endif
  node->u1.n = n;
  return;
}
...
static inline gs_void_t _gs_u (gs_t node, gs_unsigned_t u)
{
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)offsetof(struct gspin, u1.u) < gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_bv");
#endif
  node->u1.u = u;
  return;
}
...
static inline gs_void_t _gs_ull (gs_t node, gs_unsigned_long_long_t ull)
{
  ...
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.data) + sizeof(int) * 2) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_ull");
#endif
  realign.ull = ull;
  node->u1.data[0] = realign.data[0];
  node->u1.data[1] = realign.data[1];
...
static inline gs_void_t _gs_ll (gs_t node, gs_long_long_t ll)
{
  ...
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.data) + sizeof(int) * 2) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_ll");
#endif
  realign.ll = ll;
  node->u1.data[0] = realign.data[0];
  node->u1.data[1] = realign.data[1];
...
static inline gs_void_t _gs_ld (gs_t node, gs_long_double_t ld)
{
  ...
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.data) + sizeof(gs_long_double_t)) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_ld");
#endif
  realign.ld = ld;
  node->u1.data[0] = realign.data[0];
  node->u1.data[1] = realign.data[1];
...
static inline gs_void_t _gs_c (gs_t node, gs_char_t c)
{
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)offsetof(struct gspin, u0.u0s1.u0s1u.byte) < gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_c");
#endif
...
static inline gs_void_t _gs_f (gs_t node, gs_float_t f)
{
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.f) + sizeof (gs_float_t)) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_c");
#endif
  node->u1.f = f;
  return;
}
...
static inline gs_void_t _gs_d (gs_t node, gs_double_t d)
{
  ...
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.data) + sizeof (int) * 2) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_d");
#endif
  realign.d = d;
  node->u1.data[0] = realign.data[0];
  node->u1.data[1] = realign.data[1];
...
static inline gs_void_t _gs_s_no_alloc (gs_t node, const gs_string_t s)
{
  GS_ASSERT (node != (gs_t) NULL, "Got null node");
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u1.s) + sizeof (gs_string_t)) <= gspin_node_size(node->u0.u0s0.code), "Bad node size in _gs_s_no_alloc");
#endif
  node->u1.s = s;
  return;
}
...
#ifdef TARG_ST
  GS_ASSERT ((int)(offsetof(struct gspin, u0.u0s0) + sizeof (op->u0.u0s0)) <= gspin_node_size(op->u0.u0s0.code), "Bad node size in _gs_slen");
#endif
...
#define INTRN_ENUM_GSBI
#include "gfec_2_gsbi.h"
#undef INTRN_ENUM_GSBI
#endif
  GSBI_END_BUILTINS,
