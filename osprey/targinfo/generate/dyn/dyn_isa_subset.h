...
#ifndef _DYN_TARG_ISA_SUBSET_H_
#define _DYN_TARG_ISA_SUBSET_H_
...
#define  file_dyn_targ_isa_subset(extname)      str_concat(extname,_targ_isa_subset.h)
#define  file_name_dyn_subset                   file_dyn_targ_isa_subset(EXTN)

#include "targ_isa_subset.h"
#include file_name_dyn_subset                   /* Here is it! */

#undef   file_name_dyn_subset                   /* Safer!      */
#undef   file_dyn_targ_isa_subset               /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_SUBSET_H_ */
