...
#ifndef _DYN_ISA_SI_H_
#define _DYN_ISA_SI_H_
...
#define  file_dyn_isa_si(extname)               str_concat(extname,_targ_isa_si.h)
#define  file_name_dyn_si                       file_dyn_isa_si(EXTN)

#include file_name_dyn_si                       /* Here is it! */

#undef   file_name_dyn_si                       /* Safer!      */
#undef   file_dyn_isa_si                        /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_ISA_SI_H_ */
