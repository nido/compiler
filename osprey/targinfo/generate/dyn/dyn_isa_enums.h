...
#ifndef _DYN_TARG_ISA_ENUMS_H_
#define _DYN_TARG_ISA_ENUMS_H_
...
#define  file_dyn_targ_isa_enums(extname)       str_concat(extname,_targ_isa_enums.h)
#define  file_name_dyn_enums                    file_dyn_targ_isa_enums(EXTN)

#include "targ_isa_enums.h"
#include file_name_dyn_enums                    /* Here is it! */

#undef   file_name_dyn_enums                    /* Safer!      */
#undef   file_dyn_targ_isa_enums                /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_ENUMS_H_ */
