...
#ifndef _DYN_TARG_ISA_BUNDLE_H_
#define _DYN_TARG_ISA_BUNDLE_H_
...
#define  file_dyn_targ_isa_bundle(extname)  str_concat(extname,_targ_isa_bundle.h)
#define  file_name_dyn_bun                  file_dyn_targ_isa_bundle(EXTN)

#include "targ_isa_bundle.h"
#include file_name_dyn_bun                  /* Here is it! */

#undef   file_name_dyn_bun                  /* Safer!      */
#undef   file_dyn_targ_isa_bundle           /* Safer!      */
#undef   cvt_to_string                      /* Safer!      */
#undef   str_concat                         /* Safer!      */

#endif /* _DYN_TARG_ISA_BUNDLE_H_ */
