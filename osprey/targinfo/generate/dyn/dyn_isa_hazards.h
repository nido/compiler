...
#ifndef _DYN_TARG_ISA_HAZARDS_H_
#define _DYN_TARG_ISA_HAZARDS_H_
 ...
 *
 * #include "xxx_targ_isa_hazards.h"
 *
...
#define  file_dyn_targ_isa_hazards(extname)     str_concat(extname,_targ_isa_hazards.h)
#define  file_name_dyn_hazards                  file_dyn_targ_isa_hazards(EXTN)

#include "targ_isa_hazards.h"
#include file_name_dyn_hazards                  /* Here is it! */

#undef   file_name_dyn_hazards                  /* Safer!      */
#undef   file_dyn_targ_isa_hazards              /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_HAZARDS_H_ */
