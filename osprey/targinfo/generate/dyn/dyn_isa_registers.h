...
#ifndef _DYN_TARG_ISA_REGISTERS_H_
#define _DYN_TARG_ISA_REGISTERS_H_
 ...
 *
 * #include "xxx_targ_isa_registers.h"
 *
...
#define  file_dyn_targ_isa_registers(extname)   str_concat(extname,_targ_isa_registers.h)
#define  file_name_dyn_reg                      file_dyn_targ_isa_registers(EXTN)

#include "targ_isa_registers.h"
#include file_name_dyn_reg                      /* Here is it! */

#undef   file_name_dyn_reg                      /* Safer!      */
#undef   file_dyn_targ_isa_registers            /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_REGISTERS_H_ */
