...
#ifndef _DYN_TARG_ISA_VARIANTS_H_
#define _DYN_TARG_ISA_VARIANTS_H_
 ...
 *
 * #include "xxx_targ_isa_variants.h"
 *
...
#define  file_dyn_targ_isa_variants(extname)  str_concat(extname,_targ_isa_variants.h)
#define  file_name_dyn_variants                     file_dyn_targ_isa_variants(EXTN)

#include "targ_isa_variants.h"
#include file_name_dyn_variants                     /* Here is it! */

#undef   file_name_dyn_variants                     /* Safer!      */
#undef   file_dyn_targ_isa_variants           /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_VARIANTS_H_ */
