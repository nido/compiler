...
#ifndef _DYN_TARG_ISA_LITS_H_
#define _DYN_TARG_ISA_LITS_H_
...
#define  file_dyn_targ_isa_lits(extname)        str_concat(extname,_targ_isa_lits.h)
#define  file_name_dyn_lits                     file_dyn_targ_isa_lits(EXTN)

#include "targ_isa_lits.h"
#include file_name_dyn_lits                     /* Here is it! */

#undef   file_name_dyn_lits                     /* Safer!      */
#undef   file_dyn_targ_isa_lits                /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_LITS_H_ */
