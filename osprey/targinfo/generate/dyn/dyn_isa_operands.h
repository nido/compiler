...
#ifndef _DYN_TARG_ISA_OPERANDS_H_
#define _DYN_TARG_ISA_OPERANDS_H_
 ...
 *
 * #include "xxx_targ_isa_operands.h"
 *
...
#define  file_dyn_targ_isa_operands(extname)    str_concat(extname,_targ_isa_operands.h)
#define  file_name_dyn_op                       file_dyn_targ_isa_operands(EXTN)
...
#endif /* _DYN_TARG_ISA_OPERANDS_H_ */
