...
#ifndef _DYN_TOPCODE_H_
#define _DYN_TOPCODE_H_
...
#define  file_dyn_topcode(extname)  str_concat(extname,_topcode.h)
#define  file_name_dyn_top          file_dyn_topcode(EXTN)

#include "topcode.h"
#include file_name_dyn_top          /* Here is it! */

#undef   file_name_dyn_top          /* Safer!      */
#undef   file_dyn_topcode           /* Safer!      */
#undef   cvt_to_string              /* Safer!      */
#undef   str_concat                 /* Safer!      */

#endif /* _DYN_TOPCODE_H_ */
