...
#ifndef _DYN_ABI_PROPERTIES_H_
#define _DYN_ABI_PROPERTIES_H_
 ...
 *
 * #include "xxx_targ_abi_properties.h"
 *
...
#define  file_dyn_abi_properties(extname)       str_concat(extname,_targ_abi_properties.h)
#define  file_name_dyn_abi                      file_dyn_abi_properties(EXTN)

#include "targ_abi_properties.h"
#include file_name_dyn_abi                      /* Here is it! */

#undef   file_name_dyn_abi                      /* Safer!      */
#undef   file_dyn_abi_properties                /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_ABI_PROPERTIES_H_ */
