...
#ifndef _DYN_TARG_ISA_DECODE_H_
#define _DYN_TARG_ISA_DECODE_H_
...
#define  file_dyn_targ_isa_decode(extname)      str_concat(extname,_targ_isa_decode.h)
#define  file_name_dyn_op                       file_dyn_targ_isa_decode(EXTN)

#include "targ_isa_decode.h"
#include file_name_dyn_op                       /* Here is it! */

#undef   file_name_dyn_op                       /* Safer!      */
#undef   file_dyn_targ_isa_decode               /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_DECODE_H_ */
