...
#ifndef _DYN_TARG_ISA_RELOCS_H_
#define _DYN_TARG_ISA_RELOCS_H_
...
#define  file_dyn_targ_isa_relocs(extname)   str_concat(extname,_targ_isa_relocs.h)
#define  file_name_dyn_reg                      file_dyn_targ_isa_relocs(EXTN)

#include "targ_isa_relocs.h"
#include file_name_dyn_reg                      /* Here is it! */

#undef   file_name_dyn_reg                      /* Safer!      */
#undef   file_dyn_targ_isa_relocs            /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_RELOCS_H_ */
