...
#ifndef _DYN_TARG_ISA_PROPERTIES_H_
#define _DYN_TARG_ISA_PROPERTIES_H_
 ...
 *
 * #include "xxx_targ_isa_properties.h"
 *
...
#define  file_dyn_targ_isa_properties(extname)  str_concat(extname,_targ_isa_properties.h)
#define  file_name_dyn_prop                     file_dyn_targ_isa_properties(EXTN)

#include "targ_isa_properties.h"
#include file_name_dyn_prop                     /* Here is it! */

#undef   file_name_dyn_prop                     /* Safer!      */
#undef   file_dyn_targ_isa_properties           /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_PROPERTIES_H_ */
