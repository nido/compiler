...
#ifndef _DYN_TARG_ISA_PRINT_H_
#define _DYN_TARG_ISA_PRINT_H_
...
#define  file_dyn_targ_isa_print(extname)       str_concat(extname,_targ_isa_print.h)
#define  file_name_dyn_print                    file_dyn_targ_isa_print(EXTN)

#include "targ_isa_print.h"
#include file_name_dyn_print                    /* Here is it! */

#undef   file_name_dyn_print                    /* Safer!      */
#undef   file_dyn_targ_isa_print                /* Safer!      */
#undef   cvt_to_string                          /* Safer!      */
#undef   str_concat                             /* Safer!      */

#endif /* _DYN_TARG_ISA_PRINT_H_ */
