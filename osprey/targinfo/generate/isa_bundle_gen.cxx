...
/////////////////////////////////////
{
  ...
  fprintf(cfile, "\nTARGINFO_EXPORTED const ISA_BUNDLE_INFO ISA_BUNDLE_info[] = {\n");
  ...
  fprintf(hfile, "\nTARGINFO_EXPORTED extern const ISA_EXEC_UNIT_PROPERTY ISA_EXEC_unit_prop[];\n");
  fprintf(hfile, "\n");
  for (iei = all_exec_types.begin(); iei != all_exec_types.end(); ++iei) {
    ISA_EXEC_UNIT_TYPE exec_type = *iei;
    fprintf(hfile,
  ...
  fprintf (hfile, "\ninline ISA_BUNDLE_INFO "
                 ...
                 "{\n"
		 "  TARGINFO_EXPORTED extern const ISA_BUNDLE_INFO ISA_BUNDLE_info[];\n"
...
typedef enum {
  ...
  FSTOP		= 1,		// stop bit
  FTEMPLATE	= 2,		// template
  FSLOT		= 3,		// slot+n => slot n
} PACK_COMP_TYPE;
...
/////////////////////////////////////
void Pack_Stop (int comp_pos, int bundle_pos, int width)
/////////////////////////////////////
//  See interface description.
/////////////////////////////////////
{
  ...
  bundle_pack_info->fstop.comp_pos = comp_pos;
  bundle_pack_info->fstop.bundle_pos = bundle_pos;
  bundle_pack_info->fstop.width = width;
}
...
/////////////////////////////////////
{
  ...
  fprintf(hfile, "\ntypedef enum {\n"
	...
	"ISA_BUNDLE_PACK_COMP_stop", FSTOP, "Stop bit",
  ...
  pack_index = 0;
  if (bundle_pack_info->fstop.width != 0) {
    Emit_Pack_Component(cfile,
			&bundle_pack_info->fstop,
			FSTOP,
			first_comps,
			&pack_index);
  }
