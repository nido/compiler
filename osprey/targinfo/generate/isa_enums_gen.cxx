...
#define FNAME "targ_isa_enums"
  ...
  fprintf(hfile, "\ntypedef struct {\n"
		...
		"} ISA_ENUM_CLASS_INFO;\n");
  fprintf(hfile, "TARGINFO_EXPORTED extern const ISA_ENUM_CLASS_INFO ISA_ENUM_CLASS_info[];\n");
  ...
  fprintf(hfile, "TARGINFO_EXPORTED extern const ISA_ENUM_CLASS_VALUE_INFO ISA_ENUM_CLASS_VALUE_info[];\n\n");
