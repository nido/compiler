...
#define EXTENSION_NB_REGISTER_MAX           (0)
#define EXTENSION_NB_REGISTER_CLASS_MAX     (0)
#define EXTENSION_NB_REGISTER_SUBCLASS_MAX  (0)
#define EXTENSION_NB_OPERAND_MAX            (0)
#define EXTENSION_NB_RESULT_MAX             (0)
