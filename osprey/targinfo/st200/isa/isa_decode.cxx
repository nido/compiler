...
{ 
  ...
  Transitions(alu, 
	   ...
	   225,	 Final(TOP_zxth_r),
	   226,	 Final(TOP_nop),
	   227,	 Final(TOP_mov_r),
	   228,	 Final(TOP_mov_i),
	   229,	 Final(TOP_mov_ii),
	   230,	 Final(TOP_mtb),
	   231,	 Final(TOP_mfb),
	   232,	 Final(TOP_return),
	   233,	 Final(TOP_clz),
	   234,	 Final(TOP_mulhhs_r),
	   235,	 Final(TOP_mulhhs_i),
	   236,	 Final(TOP_mulhhs_ii),
	   237,	 Final(TOP_mullhus_r),
	   238,	 Final(TOP_mullhus_i),
	   239,	 Final(TOP_mullhus_ii),
	      END_TRANSITIONS); 
