...
{ 
  ...
  /* ===== Specification for E0_Unit Type ===== */ 
  E0_Unit = ISA_Exec_Unit_Type_Create("E0_Unit", NULL); 
  Instruction_Exec_Unit_Group(E0_Unit, 
  ...
  /* ===== Specification for E1_Unit Type ===== */ 
  E1_Unit = ISA_Exec_Unit_Type_Create("E1_Unit", NULL); 
  Instruction_Exec_Unit_Group(E1_Unit, 
		 TOP_GP32_LCW_GT_CRH_AR_BM_AR, 
		 TOP_GP32_LCW_GT_CRH_AR_BM_U5, 
		 TOP_GP32_LCW_GT_CRH_AR_BP_AR, 
		 TOP_GP32_LCW_GT_CRH_AR_BP_U5, 
  ...
  /* ===== Specification for G_Unit Type ===== */ 
  G_Unit = ISA_Exec_Unit_Type_Create("G_Unit", NULL); 
  Instruction_Exec_Unit_Group(G_Unit, 
  ...
  /* ===== Specification for A0_Unit Type ===== */ 
  A0_Unit = ISA_Exec_Unit_Type_Create("A0_Unit", NULL); 
  Instruction_Exec_Unit_Group(A0_Unit, 
		 TOP_GP32_SGR_GT_AR_BM_AR, 
		 TOP_GP32_SGR_GT_AR_BM_U5, 
		 TOP_GP32_SGR_GT_AR_BP_AR, 
		 TOP_GP32_SGR_GT_AR_BP_U5, 
  ...
  /* ===== Specification for A1_Unit Type ===== */ 
  A1_Unit = ISA_Exec_Unit_Type_Create("A1_Unit", NULL); 
  Instruction_Exec_Unit_Group(A1_Unit, 
  ...
  /* ===== Specification for E0ND_Unit Type ===== */ 
  E0ND_Unit = ISA_Exec_Unit_Type_Create("E0ND_Unit", NULL); 
  Instruction_Exec_Unit_Group(E0ND_Unit, 
		 TOP_GP32_LDBP_GT_DR_AR_BM_AR, 
		 TOP_GP32_LDBP_GT_DR_AR_BM_U5, 
		 TOP_GP32_LDBP_GT_DR_AR_BP_AR, 
		 TOP_GP32_LDBP_GT_DR_AR_BP_U5, 
  ...
  /* ===== Specification for D2A_Unit Type ===== */ 
  D2A_Unit = ISA_Exec_Unit_Type_Create("D2A_Unit", NULL); 
  Instruction_Exec_Unit_Group(D2A_Unit, 
		 TOP_GP32_COPYA_GT_AR_DR, 
		 TOP_GP32_COPYSA_GT_AR_DR, 
		 TOP_UNDEFINED); 

  /* ===== Specification for A2D_Unit Type ===== */ 
  A2D_Unit = ISA_Exec_Unit_Type_Create("A2D_Unit", NULL); 
  Instruction_Exec_Unit_Group(A2D_Unit, 
		 TOP_GP32_COPYD_GT_DR_AR, 
		 TOP_UNDEFINED); 

  /* ===== Specification for T_Unit Type ===== */ 
  T_Unit = ISA_Exec_Unit_Type_Create("T_Unit", NULL); 
  Instruction_Exec_Unit_Group(T_Unit, 
  ...
  /* === All legal bundle orderings (61 of them) are specified below. */ 

  /* ===== Template 0x00 (0) ===== */ 
  ISA_Bundle_Type_Create("s0_e1", ".s0_e1", 2); 
  Slot(0, S0_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (1) ===== */ 
  ISA_Bundle_Type_Create("s0_a1", ".s0_a1", 2); 
  Slot(0, S0_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (2) ===== */ 
  ISA_Bundle_Type_Create("s0_g", ".s0_g", 2); 
  Slot(0, S0_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (3) ===== */ 
  ISA_Bundle_Type_Create("s0_b", ".s0_b", 2); 
  Slot(0, S0_Unit); 
  Slot(1, B_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (4) ===== */ 
  ISA_Bundle_Type_Create("s0_d2a", ".s0_d2a", 2); 
  Slot(0, S0_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (5) ===== */ 
  ISA_Bundle_Type_Create("s0_a2d", ".s0_a2d", 2); 
  Slot(0, S0_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (6) ===== */ 
  ISA_Bundle_Type_Create("s0_t", ".s0_t", 2); 
  Slot(0, S0_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (7) ===== */ 
  ISA_Bundle_Type_Create("e0_s1", ".e0_s1", 2); 
  Slot(0, E0_Unit); 
  Slot(1, S1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (8) ===== */ 
  ISA_Bundle_Type_Create("e0_e1", ".e0_e1", 2); 
  Slot(0, E0_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (9) ===== */ 
  ISA_Bundle_Type_Create("e0_a1", ".e0_a1", 2); 
  Slot(0, E0_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (10) ===== */ 
  ISA_Bundle_Type_Create("e0_g", ".e0_g", 2); 
  Slot(0, E0_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (11) ===== */ 
  ISA_Bundle_Type_Create("e0_b", ".e0_b", 2); 
  Slot(0, E0_Unit); 
  Slot(1, B_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (12) ===== */ 
  ISA_Bundle_Type_Create("e0_d2a", ".e0_d2a", 2); 
  Slot(0, E0_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (13) ===== */ 
  ISA_Bundle_Type_Create("e0_a2d", ".e0_a2d", 2); 
  Slot(0, E0_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (14) ===== */ 
  ISA_Bundle_Type_Create("e0_t", ".e0_t", 2); 
  Slot(0, E0_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (15) ===== */ 
  ISA_Bundle_Type_Create("e0nd_s1", ".e0nd_s1", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, S1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (16) ===== */ 
  ISA_Bundle_Type_Create("e0nd_e1", ".e0nd_e1", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (17) ===== */ 
  ISA_Bundle_Type_Create("e0nd__e1", ".e0nd__e1", 2); 
  Slot(0, E0ND_Unit); 
  Stop(0); 
  Slot(1, E1_Unit); 
  Stop(1); 
  ...
  /* ===== Template 0x00 (18) ===== */ 
  ISA_Bundle_Type_Create("e0nd_a1", ".e0nd_a1", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (19) ===== */ 
  ISA_Bundle_Type_Create("e0nd_g", ".e0nd_g", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (20) ===== */ 
  ISA_Bundle_Type_Create("e0nd_b", ".e0nd_b", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, B_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (21) ===== */ 
  ISA_Bundle_Type_Create("e0nd_d2a", ".e0nd_d2a", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (22) ===== */ 
  ISA_Bundle_Type_Create("e0nd__d2a", ".e0nd__d2a", 2); 
  Slot(0, E0ND_Unit); 
  Stop(0); 
  Slot(1, D2A_Unit); 
  Stop(1); 
  ...
  /* ===== Template 0x00 (23) ===== */ 
  ISA_Bundle_Type_Create("e0nd_a2d", ".e0nd_a2d", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (24) ===== */ 
  ISA_Bundle_Type_Create("e0nd_t", ".e0nd_t", 2); 
  Slot(0, E0ND_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (25) ===== */ 
  ISA_Bundle_Type_Create("a0_e1", ".a0_e1", 2); 
  Slot(0, A0_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (26) ===== */ 
  ISA_Bundle_Type_Create("a0_g", ".a0_g", 2); 
  Slot(0, A0_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (27) ===== */ 
  ISA_Bundle_Type_Create("a0_b", ".a0_b", 2); 
  Slot(0, A0_Unit); 
  Slot(1, B_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (28) ===== */ 
  ISA_Bundle_Type_Create("a0_d2a", ".a0_d2a", 2); 
  Slot(0, A0_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (29) ===== */ 
  ISA_Bundle_Type_Create("a0_a2d", ".a0_a2d", 2); 
  Slot(0, A0_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (30) ===== */ 
  ISA_Bundle_Type_Create("a0_t", ".a0_t", 2); 
  Slot(0, A0_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (31) ===== */ 
  ISA_Bundle_Type_Create("g_s1", ".g_s1", 2); 
  Slot(0, G_Unit); 
  Slot(1, S1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (32) ===== */ 
  ISA_Bundle_Type_Create("g_e1", ".g_e1", 2); 
  Slot(0, G_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (33) ===== */ 
  ISA_Bundle_Type_Create("g_a1", ".g_a1", 2); 
  Slot(0, G_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (34) ===== */ 
  ISA_Bundle_Type_Create("g_g", ".g_g", 2); 
  Slot(0, G_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (35) ===== */ 
  ISA_Bundle_Type_Create("g_d2a", ".g_d2a", 2); 
  Slot(0, G_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (36) ===== */ 
  ISA_Bundle_Type_Create("g_a2d", ".g_a2d", 2); 
  Slot(0, G_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (37) ===== */ 
  ISA_Bundle_Type_Create("g_t", ".g_t", 2); 
  Slot(0, G_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (38) ===== */ 
  ISA_Bundle_Type_Create("b_s1", ".b_s1", 2); 
  Slot(0, B_Unit); 
  Slot(1, S1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (39) ===== */ 
  ISA_Bundle_Type_Create("b_e1", ".b_e1", 2); 
  Slot(0, B_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (40) ===== */ 
  ISA_Bundle_Type_Create("b_a1", ".b_a1", 2); 
  Slot(0, B_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (41) ===== */ 
  ISA_Bundle_Type_Create("b_d2a", ".b_d2a", 2); 
  Slot(0, B_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (42) ===== */ 
  ISA_Bundle_Type_Create("b_a2d", ".b_a2d", 2); 
  Slot(0, B_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (43) ===== */ 
  ISA_Bundle_Type_Create("b_t", ".b_t", 2); 
  Slot(0, B_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (44) ===== */ 
  ISA_Bundle_Type_Create("d2a_e1", ".d2a_e1", 2); 
  Slot(0, D2A_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (45) ===== */ 
  ISA_Bundle_Type_Create("d2a_g", ".d2a_g", 2); 
  Slot(0, D2A_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (46) ===== */ 
  ISA_Bundle_Type_Create("d2a_b", ".d2a_b", 2); 
  Slot(0, D2A_Unit); 
  Slot(1, B_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (47) ===== */ 
  ISA_Bundle_Type_Create("d2a_d2a", ".d2a_d2a", 2); 
  Slot(0, D2A_Unit); 
  Slot(1, D2A_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (48) ===== */ 
  ISA_Bundle_Type_Create("a2d_s1", ".a2d_s1", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, S1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (49) ===== */ 
  ISA_Bundle_Type_Create("a2d_e1", ".a2d_e1", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (50) ===== */ 
  ISA_Bundle_Type_Create("a2d_a1", ".a2d_a1", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (51) ===== */ 
  ISA_Bundle_Type_Create("a2d_g", ".a2d_g", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (52) ===== */ 
  ISA_Bundle_Type_Create("a2d_b", ".a2d_b", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, B_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (53) ===== */ 
  ISA_Bundle_Type_Create("a2d_a2d", ".a2d_a2d", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (54) ===== */ 
  ISA_Bundle_Type_Create("a2d_t", ".a2d_t", 2); 
  Slot(0, A2D_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (55) ===== */ 
  ISA_Bundle_Type_Create("t_s1", ".t_s1", 2); 
  Slot(0, T_Unit); 
  Slot(1, S1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (56) ===== */ 
  ISA_Bundle_Type_Create("t_e1", ".t_e1", 2); 
  Slot(0, T_Unit); 
  Slot(1, E1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (57) ===== */ 
  ISA_Bundle_Type_Create("t_a1", ".t_a1", 2); 
  Slot(0, T_Unit); 
  Slot(1, A1_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (58) ===== */ 
  ISA_Bundle_Type_Create("t_g", ".t_g", 2); 
  Slot(0, T_Unit); 
  Slot(1, G_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (59) ===== */ 
  ISA_Bundle_Type_Create("t_a2d", ".t_a2d", 2); 
  Slot(0, T_Unit); 
  Slot(1, A2D_Unit); 
  Stop(1); 

  /* ===== Template 0x00 (60) ===== */ 
  ISA_Bundle_Type_Create("t_t", ".t_t", 2); 
  Slot(0, T_Unit); 
  Slot(1, T_Unit); 
  Stop(1); 
