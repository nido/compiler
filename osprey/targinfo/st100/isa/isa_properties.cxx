...
{ 
  ISA_PROPERTY 
    gp32,            /* a GP32 operator */ 
    gp16,            /* a GP16 operator */ 
    duadd,            /* DU add */ 
    dusub,            /* DU sub */ 
    dumul,            /* DU mul */ 
    dugmi,           /* DU GMI operator */ 
    dumisc,           /* other DU operator */ 
    auadd,            /* AU add */ 
    ausub,            /* AU sub */ 
    aumul,            /* AU mul */ 
    augmi,           /* AU GMI operator */ 
    aumisc,           /* other AU operator */ 
    ...
    link,             /* Link ??? */ 
    ret,           /* return from subroutine operator */ 
    trap,             /* trap operator */ 
    madd,             /* Operator is a MAC */ 
    gci,              /* ?? */ 
    packed,           /* Packed operator */ 
    pop,              /* ?? operator */ 
    push,             /* ?? operator */ 
    predicated,       /* Operator is predicated */ 
    ...
    intrinsic,        /* Instruction is intrinsic */ 
    ...
    /* Following properties must be declared, back end 
     * requires this: 
     */ 
    simulated,        /* a macro */ 
    dummy,            /* Instruction is pseudo */  
...
/* ====================================== */ 
  push = ISA_Property_Create ("push"); 
  Instruction_Group (push, 
		 TOP_GP16_PUSH_RSET, 
		 TOP_GP16_PUSH_U5, 
		 TOP_GP32_PUSH_RSET, 
		 TOP_GP32_PUSH_U20, 
...
/* ====================================== */ 
  loopstart = ISA_Property_Create ("loopstart"); 
  Instruction_Group (loopstart, 
		 TOP_GP32_SETLS0_S16, 
		 TOP_GP32_SETLS1_S16, 
		 TOP_GP32_SETLS2_S16, 
...
/* ====================================== */ 
  packed = ISA_Property_Create ("packed"); 
  Instruction_Group (packed, 
...
/* ====================================== */ 
  ret = ISA_Property_Create ("ret"); 
  Instruction_Group (ret, 
...
/* ====================================== */ 
  partial = ISA_Property_Create ("partial"); 
  Instruction_Group (partial, 
		 TOP_GP16_MOREPR_U10, 
...
/* ====================================== */ 
  link = ISA_Property_Create ("link"); 
  Instruction_Group (link, 
...
/* ====================================== */ 
  pop = ISA_Property_Create ("pop"); 
  Instruction_Group (pop, 
		 TOP_GP16_POPRTS_RSET, 
		 TOP_GP16_POPRTS_U5, 
		 TOP_GP16_POP_RSET, 
		 TOP_GP16_POP_U5, 
...
/* ====================================== */ 
  loopend = ISA_Property_Create ("loopend"); 
...
/* ====================================== */ 
  intrinsic = ISA_Property_Create ("intrinsic"); 
  Instruction_Group (intrinsic, 
...
/* ====================================== */ 
  gci = ISA_Property_Create ("gci"); 
  Instruction_Group (gci, 
...
/* ====================================== */ 
  augmi = ISA_Property_Create ("augmi"); 
  Instruction_Group (augmi, 
		 TOP_GP16_BRANCH, 
		 TOP_GP16_BRANCH_G0F, 
...
/* ====================================== */ 
  dugmi = ISA_Property_Create ("dugmi"); 
  Instruction_Group (dugmi, 
...
/* ====================================== */ 
  synthetic = ISA_Property_Create ("synthetic"); 
  Instruction_Group (synthetic, 
		 TOP_GP16_MAKEBA_G0T_AR_U32, 
		 TOP_GP16_MAKEB_G0T_DR_S32, 
		 TOP_GP16_MAKEK_G0T_DR_S40, 
		 TOP_GP16_MOVEA_G0T_ARL_ARL, 
