...
BE_EXPORTED extern INT64 Get_Numeric_Flag (
...
BE_EXPORTED extern OPTION_GROUP Common_Option_Groups[];

/* Initialize auxiliary info for an array of OPTION_GROUPs: */
BE_EXPORTED extern void Initialize_Option_Groups ( OPTION_GROUP *ogroups );
#ifdef TARG_ST
 ...
 */
BE_EXPORTED extern void Set_Option_Internal ( OPTION_GROUP *ogroup, char *name );

/* Process the given option group: */
BE_EXPORTED extern BOOL Process_Command_Line_Group (
  char *flag,
  OPTION_GROUP *opt_groups );

/* Print/trace the settings for the given option group: */
BE_EXPORTED extern void Print_Option_Group (
...
BE_EXPORTED extern void Trace_Option_Group (
  FILE *tf,			/* Trace file */
  OPTION_GROUP *opt_group,	/* Which group? */
  BOOL full );			/* All options or only set options? */

/* Same as the above, but print an array of groups: */
BE_EXPORTED extern void Print_Option_Groups (
  FILE *tf,			/* Listing/trace file */
  ...
  BOOL full,			/* All options or only set options? */
  BOOL update );		/* Update set/mod flags after list? */
BE_EXPORTED extern void Trace_Option_Groups (
  FILE *tf,			/* Trace file */
  OPTION_GROUP *opt_group,	/* Group array */
  BOOL full );			/* All options or only set options? */

/* Get a group from an array, given its name: */
BE_EXPORTED extern OPTION_GROUP *Get_Command_Line_Group (
  OPTION_GROUP *og,
  char *name );

BE_EXPORTED extern void Trace_Command_Line_Group(FILE *, OPTION_GROUP *);

BE_EXPORTED extern void Save_or_restore_options(char *, INT32, BOOL);
