...
private:
//[HK] up from gcc-3.x, slist is now an STL extension
//    typedef std::slist<growing_table *> kids_type;
  typedef __GNUEXT::slist<growing_table *> kids_type;
...
// [HK] mempool_allocator has to be passed a pair 
