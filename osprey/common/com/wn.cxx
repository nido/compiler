	       ...
	       WN_OFFSET offset, ST* st, TY_IDX ty, WN *value, UINT field_id)
{
	...
	if (    (    (    WN_operator(value) == OPR_CVTL
             ...
             || (    (    value_opc == OPC_I4I8CVT
                       ...
                       || value_opc == OPC_U4U8CVT )
                  && ty_size < 8 )
	     // Arthur: handle I5/U5 types in the same way:
             || (    (    value_opc == OPC_I4I5CVT
                       || value_opc == OPC_I4U5CVT
                       || value_opc == OPC_U4I5CVT
                       || value_opc == OPC_U4U5CVT )
                  && ty_size < 5 ) )
	    value = WN_kid0(value);
    }
