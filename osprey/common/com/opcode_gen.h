/* opcode_gen.h: This file automatically generated. */
...
#ifdef __cplusplus
extern "C" BE_EXPORTED BOOL Is_Valid_Opcode_FUNC (OPCODE op);
BE_EXPORTED BOOL Is_Valid_Opcode_Parts(OPERATOR opr, TYPE_ID rtype, TYPE_ID desc);
#else
BE_EXPORTED extern BOOL Is_Valid_Opcode_FUNC (OPCODE op);
#endif /* __cplusplus */
