...
// BLK utilities
//----------------------------------------------------------------------
BE_EXPORTED BLK_IDX Copy_BLK (BLK_IDX b);	// copy a block

// Get the base symbol and the offset from a ST
BE_EXPORTED extern void  Base_Symbol_And_Offset (
