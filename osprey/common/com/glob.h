...
BE_EXPORTED extern char *Cur_PU_Name;	/* The current program unit name */
BE_EXPORTED extern char *Orig_PU_Name;	/* The original program unit name in source */
...
BE_EXPORTED extern PU_KIND Cur_PU_Kind;

/* Current file names: */
BE_EXPORTED extern char * Src_File_Name;      /* Source file */
BE_EXPORTED extern char * Orig_Src_File_Name; /* Original source file passed to driver */
BE_EXPORTED extern char * Cpp_File_Name;	/* cpp-preprocessed file */
BE_EXPORTED extern char * Lst_File_Name; /* Listing file */
BE_EXPORTED extern char * Err_File_Name;	/* Error file */
BE_EXPORTED extern char * Trc_File_Name;	/* Trace file */
BE_EXPORTED extern char * Tlog_File_Name;	/* Transformation log file */
BE_EXPORTED extern char * Irb_File_Name;	/* ACIR intermediate file */
BE_EXPORTED extern char * IR_File_Name;	/* SGIR intermediate file */
BE_EXPORTED extern char * Ipa_File_Name;	/* IPA file */
BE_EXPORTED extern char * Asm_File_Name;	/* Assembly file */
...
#endif
BE_EXPORTED extern char * Lib_Lock_Name;	/* Program library lock file */
BE_EXPORTED extern char * DSTdump_File_Name; /* Dwarf intermediate (i.e. DST) dump file */
BE_EXPORTED extern char * Global_File_Name;	/* Global symbol table file */

/* Current file handles if open, NULL otherwise: */
BE_EXPORTED extern FILE * Src_File;		/* Source file */
BE_EXPORTED extern FILE * Cpp_File;		/* cpp-preprocessed file */
BE_EXPORTED extern FILE * Lst_File;		/* Listing file */
BE_EXPORTED extern FILE * Err_File;		/* Error file */
BE_EXPORTED extern FILE * Trc_File;		/* Trace file */
BE_EXPORTED extern FILE * Tlog_File;		/* Transformation log file */
BE_EXPORTED extern FILE * Irb_File;		/* ACIR intermediate file */
BE_EXPORTED extern FILE * IR_File;		/* SGIR intermediate file */
BE_EXPORTED extern FILE * Ipa_File;		/* IPA file */
BE_EXPORTED extern FILE * Asm_File;		/* Assembly file */
BE_EXPORTED extern FILE * Lai_File;          /* LAI file */
BE_EXPORTED extern FILE * Obj_File;		/* Relocatable object file */
BE_EXPORTED extern FILE * Lib_File;		/* Program library file */
BE_EXPORTED extern FILE * Tim_File;		/* Timing info file (usually trace) */
#ifdef MONGOOSE_BE
...
BE_EXPORTED extern INT32 Num_Source_Files;

/* Output requested: */
CG_EXPORTED extern BOOL Assembly;		/* Assembly code */
CG_EXPORTED extern BOOL Lai_Code;           /* Lai code */
CG_EXPORTED extern BOOL Object_Code;	/* Object code */
BE_EXPORTED extern BOOL Symbol_Table_Out;	/* Symbol table output (list or trace) */
BE_EXPORTED extern BOOL Show_Progress;	/* Report progress to stdout */
...
BE_EXPORTED extern void Terminate ( INT status );

/* ====================================================================
 *
 ...
 */
BE_EXPORTED extern INT32 Fe_Process_Id;
BE_EXPORTED extern INT32 Fe_Process_Time;
BE_EXPORTED extern char * Fe_Version;
BE_EXPORTED extern BOOL Fe_Josie;	/* Did .B come from a Josie front end? */
...
BE_EXPORTED extern BOOL Regcopies_Translated;
