/* opcode_gen_core.h: This file automatically generated. */
...
BE_EXPORTED extern struct OPERATOR_info_struct {
  char		_name[23];
  mINT8		nkids;
...
typedef enum {
  ...
  OPC_I5ABS	 = OPR_ABS + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  ...
  OPC_I5ADD	 = OPR_ADD + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5ADD	 = OPR_ADD + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5ARRAYEXP	 = OPR_ARRAYEXP + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5ARRAYEXP	 = OPR_ARRAYEXP + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5ASHR	 = OPR_ASHR + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5ASHR	 = OPR_ASHR + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5BAND	 = OPR_BAND + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5BAND	 = OPR_BAND + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5BIOR	 = OPR_BIOR + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5BIOR	 = OPR_BIOR + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5BNOR	 = OPR_BNOR + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5BNOR	 = OPR_BNOR + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5BNOT	 = OPR_BNOT + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5BNOT	 = OPR_BNOT + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5BXOR	 = OPR_BXOR + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5BXOR	 = OPR_BXOR + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5CALL	 = OPR_CALL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5CALL	 = OPR_CALL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5F4CEIL	 = OPR_CEIL + RTYPE(MTYPE_I5) + DESC(MTYPE_F4),
  OPC_I5F8CEIL	 = OPR_CEIL + RTYPE(MTYPE_I5) + DESC(MTYPE_F8),
  OPC_I5F10CEIL	 = OPR_CEIL + RTYPE(MTYPE_I5) + DESC(MTYPE_F10),
  OPC_I5F16CEIL	 = OPR_CEIL + RTYPE(MTYPE_I5) + DESC(MTYPE_F16),
  OPC_I5FQCEIL	 = OPR_CEIL + RTYPE(MTYPE_I5) + DESC(MTYPE_FQ),
  OPC_U5F4CEIL	 = OPR_CEIL + RTYPE(MTYPE_U5) + DESC(MTYPE_F4),
  OPC_U5F8CEIL	 = OPR_CEIL + RTYPE(MTYPE_U5) + DESC(MTYPE_F8),
  OPC_U5F10CEIL	 = OPR_CEIL + RTYPE(MTYPE_U5) + DESC(MTYPE_F10),
  OPC_U5F16CEIL	 = OPR_CEIL + RTYPE(MTYPE_U5) + DESC(MTYPE_F16),
  OPC_U5FQCEIL	 = OPR_CEIL + RTYPE(MTYPE_U5) + DESC(MTYPE_FQ),
  ...
  OPC_I5COMMA	 = OPR_COMMA + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5COMMA	 = OPR_COMMA + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5CONST	 = OPR_CONST + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5CONST	 = OPR_CONST + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5CSELECT	 = OPR_CSELECT + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5CSELECT	 = OPR_CSELECT + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I4I5CVT	 = OPR_CVT + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5CVT	 = OPR_CVT + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5CVT	 = OPR_CVT + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5CVT	 = OPR_CVT + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5CVT	 = OPR_CVT + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5CVT	 = OPR_CVT + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5CVT	 = OPR_CVT + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5CVT	 = OPR_CVT + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_I5BCVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_B),
  OPC_I5I4CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_I4),
  OPC_I5I8CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_I8),
  OPC_I5U4CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_U4),
  OPC_I5U8CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_U8),
  OPC_I5U5CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_U5),
  OPC_I5A4CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_A4),
  OPC_I5A8CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_A8),
  OPC_I5F4CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_F4),
  OPC_I5F8CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_F8),
  OPC_I5F10CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_F10),
  OPC_I5F16CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_F16),
  OPC_I5FQCVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_FQ),
  OPC_I5I16CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_I16),
  OPC_I5U16CVT	 = OPR_CVT + RTYPE(MTYPE_I5) + DESC(MTYPE_U16),
  OPC_U5BCVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_B),
  OPC_U5I4CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_I4),
  OPC_U5I8CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_I8),
  OPC_U5U4CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_U4),
  OPC_U5U8CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_U8),
  OPC_U5I5CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_I5),
  OPC_U5A4CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_A4),
  OPC_U5A8CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_A8),
  OPC_U5F4CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_F4),
  OPC_U5F8CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_F8),
  OPC_U5F10CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_F10),
  OPC_U5F16CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_F16),
  OPC_U5FQCVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_FQ),
  OPC_U5I16CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_I16),
  OPC_U5U16CVT	 = OPR_CVT + RTYPE(MTYPE_U5) + DESC(MTYPE_U16),
  ...
  OPC_A4I5CVT	 = OPR_CVT + RTYPE(MTYPE_A4) + DESC(MTYPE_I5),
  OPC_A4U5CVT	 = OPR_CVT + RTYPE(MTYPE_A4) + DESC(MTYPE_U5),
  ...
  OPC_A8I5CVT	 = OPR_CVT + RTYPE(MTYPE_A8) + DESC(MTYPE_I5),
  OPC_A8U5CVT	 = OPR_CVT + RTYPE(MTYPE_A8) + DESC(MTYPE_U5),
  ...
  OPC_F4I5CVT	 = OPR_CVT + RTYPE(MTYPE_F4) + DESC(MTYPE_I5),
  OPC_F4U5CVT	 = OPR_CVT + RTYPE(MTYPE_F4) + DESC(MTYPE_U5),
  ...
  OPC_F8I5CVT	 = OPR_CVT + RTYPE(MTYPE_F8) + DESC(MTYPE_I5),
  OPC_F8U5CVT	 = OPR_CVT + RTYPE(MTYPE_F8) + DESC(MTYPE_U5),
  ...
  OPC_F10I5CVT	 = OPR_CVT + RTYPE(MTYPE_F10) + DESC(MTYPE_I5),
  OPC_F10U5CVT	 = OPR_CVT + RTYPE(MTYPE_F10) + DESC(MTYPE_U5),
  ...
  OPC_F16I5CVT	 = OPR_CVT + RTYPE(MTYPE_F16) + DESC(MTYPE_I5),
  OPC_F16U5CVT	 = OPR_CVT + RTYPE(MTYPE_F16) + DESC(MTYPE_U5),
  ...
  OPC_FQI5CVT	 = OPR_CVT + RTYPE(MTYPE_FQ) + DESC(MTYPE_I5),
  OPC_FQU5CVT	 = OPR_CVT + RTYPE(MTYPE_FQ) + DESC(MTYPE_U5),
  ...
  OPC_I16I5CVT	 = OPR_CVT + RTYPE(MTYPE_I16) + DESC(MTYPE_I5),
  OPC_I16U5CVT	 = OPR_CVT + RTYPE(MTYPE_I16) + DESC(MTYPE_U5),
  ...
  OPC_U16I5CVT	 = OPR_CVT + RTYPE(MTYPE_U16) + DESC(MTYPE_I5),
  OPC_U16U5CVT	 = OPR_CVT + RTYPE(MTYPE_U16) + DESC(MTYPE_U5),
  ...
  OPC_I5CVTL	 = OPR_CVTL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5CVTL	 = OPR_CVTL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5DIV	 = OPR_DIV + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5DIV	 = OPR_DIV + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5DIVREM	 = OPR_DIVREM + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5DIVREM	 = OPR_DIVREM + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_BI5EQ	 = OPR_EQ + RTYPE(MTYPE_B) + DESC(MTYPE_I5),
  OPC_BU5EQ	 = OPR_EQ + RTYPE(MTYPE_B) + DESC(MTYPE_U5),
  ...
  OPC_I4I5EQ	 = OPR_EQ + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5EQ	 = OPR_EQ + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5EQ	 = OPR_EQ + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5EQ	 = OPR_EQ + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5EQ	 = OPR_EQ + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5EQ	 = OPR_EQ + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5EQ	 = OPR_EQ + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5EQ	 = OPR_EQ + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_I5F4FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_I5) + DESC(MTYPE_F4),
  OPC_I5F8FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_I5) + DESC(MTYPE_F8),
  OPC_I5F10FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_I5) + DESC(MTYPE_F10),
  OPC_I5F16FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_I5) + DESC(MTYPE_F16),
  OPC_I5FQFLOOR	 = OPR_FLOOR + RTYPE(MTYPE_I5) + DESC(MTYPE_FQ),
  OPC_U5F4FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_U5) + DESC(MTYPE_F4),
  OPC_U5F8FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_U5) + DESC(MTYPE_F8),
  OPC_U5F10FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_U5) + DESC(MTYPE_F10),
  OPC_U5F16FLOOR	 = OPR_FLOOR + RTYPE(MTYPE_U5) + DESC(MTYPE_F16),
  OPC_U5FQFLOOR	 = OPR_FLOOR + RTYPE(MTYPE_U5) + DESC(MTYPE_FQ),
  ...
  OPC_BI5GE	 = OPR_GE + RTYPE(MTYPE_B) + DESC(MTYPE_I5),
  OPC_BU5GE	 = OPR_GE + RTYPE(MTYPE_B) + DESC(MTYPE_U5),
  ...
  OPC_I4I5GE	 = OPR_GE + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5GE	 = OPR_GE + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5GE	 = OPR_GE + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5GE	 = OPR_GE + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5GE	 = OPR_GE + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5GE	 = OPR_GE + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5GE	 = OPR_GE + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5GE	 = OPR_GE + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_BI5GT	 = OPR_GT + RTYPE(MTYPE_B) + DESC(MTYPE_I5),
  OPC_BU5GT	 = OPR_GT + RTYPE(MTYPE_B) + DESC(MTYPE_U5),
  ...
  OPC_I4I5GT	 = OPR_GT + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5GT	 = OPR_GT + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5GT	 = OPR_GT + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5GT	 = OPR_GT + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5GT	 = OPR_GT + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5GT	 = OPR_GT + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5GT	 = OPR_GT + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5GT	 = OPR_GT + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_I5HIGHMPY	 = OPR_HIGHMPY + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5HIGHMPY	 = OPR_HIGHMPY + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5HIGHPART	 = OPR_HIGHPART + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5HIGHPART	 = OPR_HIGHPART + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5ICALL	 = OPR_ICALL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5ICALL	 = OPR_ICALL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I4I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_I4),
  OPC_I4I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_I8),
  OPC_I4U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U1),
  OPC_I4U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U2),
  OPC_I4U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U4),
  OPC_I4U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U8),
  OPC_I8I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I1),
  OPC_I8I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I2),
  OPC_I8I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I4),
  OPC_I8I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I8),
  OPC_I8U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U1),
  OPC_I8U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U2),
  OPC_I8U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U4),
  OPC_I8U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U8),
  OPC_U4I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I1),
  OPC_U4I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I2),
  OPC_U4I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I4),
  OPC_U4I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I8),
  OPC_U4U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U1),
  OPC_U4U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U2),
  OPC_U4U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U4),
  OPC_U4U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U8),
  OPC_U8I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I1),
  OPC_U8I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I2),
  OPC_U8I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I4),
  OPC_U8I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I8),
  OPC_U8U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U1),
  OPC_U8U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U2),
  OPC_U8U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U4),
  OPC_U8U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U8),
  OPC_I5I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I1),
  OPC_I5I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I2),
  OPC_I5I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I4),
  OPC_I5I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I8),
  OPC_I5U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U1),
  OPC_I5U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U2),
  OPC_I5U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U4),
  OPC_I5U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U8),
  OPC_U5I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I1),
  OPC_U5I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I2),
  OPC_U5I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I4),
  OPC_U5I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I8),
  OPC_U5U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U1),
  OPC_U5U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U2),
  OPC_U5U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U4),
  OPC_U5U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U8),
  OPC_I16I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I1),
  OPC_I16I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I2),
  OPC_I16I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I4),
  OPC_I16I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I8),
  OPC_I16U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U1),
  OPC_I16U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U2),
  OPC_I16U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U4),
  OPC_I16U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U8),
  OPC_U16I1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I1),
  OPC_U16I2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I2),
  OPC_U16I4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I4),
  OPC_U16I8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I8),
  OPC_U16U1ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U1),
  OPC_U16U2ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U2),
  OPC_U16U4ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U4),
  OPC_U16U8ILDBITS	 = OPR_ILDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U8),
  OPC_BBILOAD	 = OPR_ILOAD + RTYPE(MTYPE_B) + DESC(MTYPE_B),
  ...
  OPC_I4I5ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  ...
  OPC_I8I5ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  ...
  OPC_U4U5ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8U5ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  OPC_U8BSILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U8) + DESC(MTYPE_BS),
  OPC_I5I1ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I5) + DESC(MTYPE_I1),
  OPC_I5I2ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I5) + DESC(MTYPE_I2),
  OPC_I5I4ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I5) + DESC(MTYPE_I4),
  OPC_I5I8ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I5) + DESC(MTYPE_I8),
  OPC_I5I5ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I5) + DESC(MTYPE_I5),
  OPC_I5BSILOAD	 = OPR_ILOAD + RTYPE(MTYPE_I5) + DESC(MTYPE_BS),
  OPC_U5U1ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U5) + DESC(MTYPE_U1),
  OPC_U5U2ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U5) + DESC(MTYPE_U2),
  OPC_U5U4ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U5) + DESC(MTYPE_U4),
  OPC_U5U8ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U5) + DESC(MTYPE_U8),
  OPC_U5U5ILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U5) + DESC(MTYPE_U5),
  OPC_U5BSILOAD	 = OPR_ILOAD + RTYPE(MTYPE_U5) + DESC(MTYPE_BS),
  ...
  OPC_I5INTCONST	 = OPR_INTCONST + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5INTCONST	 = OPR_INTCONST + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5INTRINSIC_CALL	 = OPR_INTRINSIC_CALL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5INTRINSIC_CALL	 = OPR_INTRINSIC_CALL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5INTRINSIC_OP	 = OPR_INTRINSIC_OP + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5INTRINSIC_OP	 = OPR_INTRINSIC_OP + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I4ISTBITS	 = OPR_ISTBITS + RTYPE(MTYPE_V) + DESC(MTYPE_I4),
  OPC_I8ISTBITS	 = OPR_ISTBITS + RTYPE(MTYPE_V) + DESC(MTYPE_I8),
  OPC_U1ISTBITS	 = OPR_ISTBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U1),
  OPC_U2ISTBITS	 = OPR_ISTBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U2),
  OPC_U4ISTBITS	 = OPR_ISTBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U4),
  OPC_U8ISTBITS	 = OPR_ISTBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U8),
  OPC_BISTORE	 = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_B),
  ...
  OPC_I5ISTORE	 = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_I5),
  OPC_U5ISTORE	 = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_U5),
  ...
  OPC_I4I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_I4),
  OPC_I4I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_I8),
  OPC_I4U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U1),
  OPC_I4U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U2),
  OPC_I4U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U4),
  OPC_I4U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I4) + DESC(MTYPE_U8),
  OPC_I8I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I1),
  OPC_I8I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I2),
  OPC_I8I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I4),
  OPC_I8I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_I8),
  OPC_I8U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U1),
  OPC_I8U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U2),
  OPC_I8U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U4),
  OPC_I8U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I8) + DESC(MTYPE_U8),
  OPC_U4I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I1),
  OPC_U4I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I2),
  OPC_U4I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I4),
  OPC_U4I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_I8),
  OPC_U4U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U1),
  OPC_U4U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U2),
  OPC_U4U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U4),
  OPC_U4U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U4) + DESC(MTYPE_U8),
  OPC_U8I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I1),
  OPC_U8I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I2),
  OPC_U8I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I4),
  OPC_U8I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_I8),
  OPC_U8U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U1),
  OPC_U8U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U2),
  OPC_U8U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U4),
  OPC_U8U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U8) + DESC(MTYPE_U8),
  OPC_I5I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I1),
  OPC_I5I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I2),
  OPC_I5I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I4),
  OPC_I5I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_I8),
  OPC_I5U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U1),
  OPC_I5U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U2),
  OPC_I5U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U4),
  OPC_I5U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I5) + DESC(MTYPE_U8),
  OPC_U5I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I1),
  OPC_U5I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I2),
  OPC_U5I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I4),
  OPC_U5I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_I8),
  OPC_U5U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U1),
  OPC_U5U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U2),
  OPC_U5U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U4),
  OPC_U5U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U5) + DESC(MTYPE_U8),
  OPC_I16I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I1),
  OPC_I16I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I2),
  OPC_I16I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I4),
  OPC_I16I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_I8),
  OPC_I16U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U1),
  OPC_I16U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U2),
  OPC_I16U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U4),
  OPC_I16U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_I16) + DESC(MTYPE_U8),
  OPC_U16I1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I1),
  OPC_U16I2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I2),
  OPC_U16I4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I4),
  OPC_U16I8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_I8),
  OPC_U16U1LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U1),
  OPC_U16U2LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U2),
  OPC_U16U4LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U4),
  OPC_U16U8LDBITS	 = OPR_LDBITS + RTYPE(MTYPE_U16) + DESC(MTYPE_U8),
  OPC_BBLDID	 = OPR_LDID + RTYPE(MTYPE_B) + DESC(MTYPE_B),
  ...
  OPC_I4I5LDID	 = OPR_LDID + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  ...
  OPC_I8I5LDID	 = OPR_LDID + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  ...
  OPC_U4U5LDID	 = OPR_LDID + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8U5LDID	 = OPR_LDID + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  OPC_U8BSLDID	 = OPR_LDID + RTYPE(MTYPE_U8) + DESC(MTYPE_BS),
  OPC_I5I1LDID	 = OPR_LDID + RTYPE(MTYPE_I5) + DESC(MTYPE_I1),
  OPC_I5I2LDID	 = OPR_LDID + RTYPE(MTYPE_I5) + DESC(MTYPE_I2),
  OPC_I5I4LDID	 = OPR_LDID + RTYPE(MTYPE_I5) + DESC(MTYPE_I4),
  OPC_I5I8LDID	 = OPR_LDID + RTYPE(MTYPE_I5) + DESC(MTYPE_I8),
  OPC_I5I5LDID	 = OPR_LDID + RTYPE(MTYPE_I5) + DESC(MTYPE_I5),
  OPC_I5BSLDID	 = OPR_LDID + RTYPE(MTYPE_I5) + DESC(MTYPE_BS),
  OPC_U5U1LDID	 = OPR_LDID + RTYPE(MTYPE_U5) + DESC(MTYPE_U1),
  OPC_U5U2LDID	 = OPR_LDID + RTYPE(MTYPE_U5) + DESC(MTYPE_U2),
  OPC_U5U4LDID	 = OPR_LDID + RTYPE(MTYPE_U5) + DESC(MTYPE_U4),
  OPC_U5U8LDID	 = OPR_LDID + RTYPE(MTYPE_U5) + DESC(MTYPE_U8),
  OPC_U5U5LDID	 = OPR_LDID + RTYPE(MTYPE_U5) + DESC(MTYPE_U5),
  OPC_U5BSLDID	 = OPR_LDID + RTYPE(MTYPE_U5) + DESC(MTYPE_BS),
  ...
  OPC_BI5LE	 = OPR_LE + RTYPE(MTYPE_B) + DESC(MTYPE_I5),
  OPC_BU5LE	 = OPR_LE + RTYPE(MTYPE_B) + DESC(MTYPE_U5),
  ...
  OPC_I4I5LE	 = OPR_LE + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5LE	 = OPR_LE + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5LE	 = OPR_LE + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5LE	 = OPR_LE + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5LE	 = OPR_LE + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5LE	 = OPR_LE + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5LE	 = OPR_LE + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5LE	 = OPR_LE + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_I5LOWPART	 = OPR_LOWPART + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5LOWPART	 = OPR_LOWPART + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5LSHR	 = OPR_LSHR + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5LSHR	 = OPR_LSHR + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_BI5LT	 = OPR_LT + RTYPE(MTYPE_B) + DESC(MTYPE_I5),
  OPC_BU5LT	 = OPR_LT + RTYPE(MTYPE_B) + DESC(MTYPE_U5),
  ...
  OPC_I4I5LT	 = OPR_LT + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5LT	 = OPR_LT + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5LT	 = OPR_LT + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5LT	 = OPR_LT + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5LT	 = OPR_LT + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5LT	 = OPR_LT + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5LT	 = OPR_LT + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5LT	 = OPR_LT + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_I5MADD	 = OPR_MADD + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MADD	 = OPR_MADD + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I16MADD	 = OPR_MADD + RTYPE(MTYPE_I16) + DESC(MTYPE_V),
  OPC_U16MADD	 = OPR_MADD + RTYPE(MTYPE_U16) + DESC(MTYPE_V),
  ...
  OPC_I5MAX	 = OPR_MAX + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MAX	 = OPR_MAX + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5MAXPART	 = OPR_MAXPART + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MAXPART	 = OPR_MAXPART + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5MIN	 = OPR_MIN + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MIN	 = OPR_MIN + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5MINMAX	 = OPR_MINMAX + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MINMAX	 = OPR_MINMAX + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5MINPART	 = OPR_MINPART + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MINPART	 = OPR_MINPART + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5MOD	 = OPR_MOD + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MOD	 = OPR_MOD + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5MPY	 = OPR_MPY + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5MPY	 = OPR_MPY + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  OPC_A4MPY	 = OPR_MPY + RTYPE(MTYPE_A4) + DESC(MTYPE_V),
  OPC_A8MPY	 = OPR_MPY + RTYPE(MTYPE_A8) + DESC(MTYPE_V),
  ...
  OPC_BI5NE	 = OPR_NE + RTYPE(MTYPE_B) + DESC(MTYPE_I5),
  OPC_BU5NE	 = OPR_NE + RTYPE(MTYPE_B) + DESC(MTYPE_U5),
  ...
  OPC_I4I5NE	 = OPR_NE + RTYPE(MTYPE_I4) + DESC(MTYPE_I5),
  OPC_I4U5NE	 = OPR_NE + RTYPE(MTYPE_I4) + DESC(MTYPE_U5),
  ...
  OPC_I8I5NE	 = OPR_NE + RTYPE(MTYPE_I8) + DESC(MTYPE_I5),
  OPC_I8U5NE	 = OPR_NE + RTYPE(MTYPE_I8) + DESC(MTYPE_U5),
  ...
  OPC_U4I5NE	 = OPR_NE + RTYPE(MTYPE_U4) + DESC(MTYPE_I5),
  OPC_U4U5NE	 = OPR_NE + RTYPE(MTYPE_U4) + DESC(MTYPE_U5),
  ...
  OPC_U8I5NE	 = OPR_NE + RTYPE(MTYPE_U8) + DESC(MTYPE_I5),
  OPC_U8U5NE	 = OPR_NE + RTYPE(MTYPE_U8) + DESC(MTYPE_U5),
  ...
  OPC_I5NEG	 = OPR_NEG + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5NEG	 = OPR_NEG + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  OPC_A4NEG	 = OPR_NEG + RTYPE(MTYPE_A4) + DESC(MTYPE_V),
  OPC_A8NEG	 = OPR_NEG + RTYPE(MTYPE_A8) + DESC(MTYPE_V),
  ...
  OPC_I5OPTPARM	 = OPR_OPTPARM + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5OPTPARM	 = OPR_OPTPARM + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5PARM	 = OPR_PARM + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5PARM	 = OPR_PARM + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5PICCALL	 = OPR_PICCALL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5PICCALL	 = OPR_PICCALL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5RCOMMA	 = OPR_RCOMMA + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5RCOMMA	 = OPR_RCOMMA + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5REM	 = OPR_REM + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5REM	 = OPR_REM + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5RETURN_VAL	 = OPR_RETURN_VAL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5RETURN_VAL	 = OPR_RETURN_VAL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5F4RND	 = OPR_RND + RTYPE(MTYPE_I5) + DESC(MTYPE_F4),
  OPC_I5F8RND	 = OPR_RND + RTYPE(MTYPE_I5) + DESC(MTYPE_F8),
  OPC_I5F10RND	 = OPR_RND + RTYPE(MTYPE_I5) + DESC(MTYPE_F10),
  OPC_I5F16RND	 = OPR_RND + RTYPE(MTYPE_I5) + DESC(MTYPE_F16),
  OPC_I5FQRND	 = OPR_RND + RTYPE(MTYPE_I5) + DESC(MTYPE_FQ),
  OPC_U5F4RND	 = OPR_RND + RTYPE(MTYPE_U5) + DESC(MTYPE_F4),
  OPC_U5F8RND	 = OPR_RND + RTYPE(MTYPE_U5) + DESC(MTYPE_F8),
  OPC_U5F10RND	 = OPR_RND + RTYPE(MTYPE_U5) + DESC(MTYPE_F10),
  OPC_U5F16RND	 = OPR_RND + RTYPE(MTYPE_U5) + DESC(MTYPE_F16),
  OPC_U5FQRND	 = OPR_RND + RTYPE(MTYPE_U5) + DESC(MTYPE_FQ),
  ...
  OPC_I5BSELECT	 = OPR_SELECT + RTYPE(MTYPE_I5) + DESC(MTYPE_B),
  OPC_I5SELECT	 = OPR_SELECT + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5BSELECT	 = OPR_SELECT + RTYPE(MTYPE_U5) + DESC(MTYPE_B),
  OPC_U5SELECT	 = OPR_SELECT + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5SHL	 = OPR_SHL + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5SHL	 = OPR_SHL + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I4STBITS	 = OPR_STBITS + RTYPE(MTYPE_V) + DESC(MTYPE_I4),
  OPC_I8STBITS	 = OPR_STBITS + RTYPE(MTYPE_V) + DESC(MTYPE_I8),
  OPC_U1STBITS	 = OPR_STBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U1),
  OPC_U2STBITS	 = OPR_STBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U2),
  OPC_U4STBITS	 = OPR_STBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U4),
  OPC_U8STBITS	 = OPR_STBITS + RTYPE(MTYPE_V) + DESC(MTYPE_U8),
  OPC_BSTID	 = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_B),
  ...
  OPC_I5STID	 = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_I5),
  OPC_U5STID	 = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_U5),
  ...
  OPC_I5SUB	 = OPR_SUB + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5SUB	 = OPR_SUB + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5TAS	 = OPR_TAS + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5TAS	 = OPR_TAS + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5TRIPLET	 = OPR_TRIPLET + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5TRIPLET	 = OPR_TRIPLET + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5F4TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_I5) + DESC(MTYPE_F4),
  OPC_I5F8TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_I5) + DESC(MTYPE_F8),
  OPC_I5F10TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_I5) + DESC(MTYPE_F10),
  OPC_I5F16TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_I5) + DESC(MTYPE_F16),
  OPC_I5FQTRUNC	 = OPR_TRUNC + RTYPE(MTYPE_I5) + DESC(MTYPE_FQ),
  OPC_U5F4TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_U5) + DESC(MTYPE_F4),
  OPC_U5F8TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_U5) + DESC(MTYPE_F8),
  OPC_U5F10TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_U5) + DESC(MTYPE_F10),
  OPC_U5F16TRUNC	 = OPR_TRUNC + RTYPE(MTYPE_U5) + DESC(MTYPE_F16),
  OPC_U5FQTRUNC	 = OPR_TRUNC + RTYPE(MTYPE_U5) + DESC(MTYPE_FQ),
  ...
  OPC_I5XMPY	 = OPR_XMPY + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5XMPY	 = OPR_XMPY + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_I5ASM_EXPR	 = OPR_ASM_EXPR + RTYPE(MTYPE_I5) + DESC(MTYPE_V),
  OPC_U5ASM_EXPR	 = OPR_ASM_EXPR + RTYPE(MTYPE_U5) + DESC(MTYPE_V),
  ...
  OPC_U4U1LROTATE	 = OPR_LROTATE + RTYPE(MTYPE_U4) + DESC(MTYPE_U1),
  OPC_U4U2LROTATE	 = OPR_LROTATE + RTYPE(MTYPE_U4) + DESC(MTYPE_U2),
  OPC_U4U4LROTATE	 = OPR_LROTATE + RTYPE(MTYPE_U4) + DESC(MTYPE_U4),
  OPC_U8U8LROTATE	 = OPR_LROTATE + RTYPE(MTYPE_U8) + DESC(MTYPE_U8),
#ifdef TARG_ST
