...
// [HK] CM's solution to resolve issues of warnings with gcc-3.x, due to the misuse of the offsetof macro 
#if __GNUC__ >= 3
#define WN_SILENT_OFFSETOF(T,f) ((size_t)(&(reinterpret_cast<T*>(__alignof__(T *)))->f) - __alignof__(T *))
#define WN_OFFSET_IN_STMT_WN (WN_SILENT_OFFSETOF(STMT_WN,wn))
#else
