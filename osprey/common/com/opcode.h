...
BE_EXPORTED extern const char	*OPERATOR_name(OPERATOR);
BE_EXPORTED extern OPCODE           OPCODE_commutative_op(OPCODE op);
...
CG_EXPORTED inline OPCODE OPCODE_make_op(OPERATOR opr, TYPE_ID rtype, TYPE_ID desc)
{
  OPCODE ret;
