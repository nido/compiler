...
BE_EXPORTED extern ST *Find_Return_Registers(TYPE_ID type,PREG_NUM *rreg1,PREG_NUM *rreg2);
...
#if defined(__linux) || defined(__sun) || defined(__CYGWIN__) || defined(__MINGW32__)
