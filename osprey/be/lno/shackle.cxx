...
#ifdef TARG_ST
      // [CG] We check explicitly that the WNs have a symbol before
      // accessing it. (in debug mode this may cause an assertion).
      if (!WN_has_sym(t1) || !WN_has_sym(t2)) return NULL;
#endif
