...
private:
  // Arthur: a little redesign of this structure, because
  //         _mclass does not fit in 3 bits anymore:
  // _more_flags becomes 8 bits,
  // _mclass becomes 8 bits
