...
private:
  ...
  __GNUEXT::hash_map< LABEL_IDX, FB_NODEX, __GNUEXT::hash<LABEL_IDX>, __GNUEXT::equal_to<LABEL_IDX>,
...
public:
  ...
  FB_CFG() :
    ...
    _lblx_to_nx( 100, __GNUEXT::hash<LABEL_IDX>(), __GNUEXT::equal_to<LABEL_IDX>(),
