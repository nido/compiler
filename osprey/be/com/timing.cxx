...
Initialize_Timing ( BOOL enable )
{
  ...
  if ( Enabled = enable ) {
    ...
    Timer ( T_LAO_Interface_CU ) =
	    Resource_Alloc ( "  LAO Interface", Timer(T_LAO_Interface_Comp) );
    Timer ( T_LAO_PRE_Comp ) =
	    Resource_Alloc ( "  LAO Prepass Optimizations", NULL );
    Timer ( T_LAO_PRE_CU ) =
	    Resource_Alloc ( "  LAO Prepass Optimizations", Timer(T_LAO_PRE_Comp) );
    Timer ( T_LAO_REG_Comp ) =
	    Resource_Alloc ( "  LAO Register Allocation", NULL );
    Timer ( T_LAO_REG_CU ) =
	    Resource_Alloc ( "  LAO Register Allocation", Timer(T_LAO_REG_Comp) );
    Timer ( T_LAO_POST_Comp ) =
