...
BE_EXPORTED extern void WN_Instrument( WN *wn, PROFILE_PHASE phase );

BE_EXPORTED extern void WN_Annotate(   WN *wn, PROFILE_PHASE phase,
			   MEM_POOL *MEM_pu_pool );

BE_EXPORTED extern void Set_Instrumentation_File_Name( char *fname );

// TB: to reuse code for wn_coverage.cxx
