...
extern "C" BOOL symbol_linkonce (ST_IDX st_idx); // [CL] support for linkonce
#endif
...
struct IPC_GLOBAL_IDX_MAP
{
	...
	sym_str (0, __GNUEXT::hash<STR_IDX>(), __GNUEXT::equal_to<STR_IDX> (),
...
typedef __GNUEXT::hash_map<ST_IDX, INITO_IDX> ST_TO_INITO_MAP;
...
typedef __GNUEXT::hash_map<ST_IDX, BLOCK_ELEMENTS*, __GNUEXT::hash<ST_IDX>, __GNUEXT::equal_to<ST_IDX>,
