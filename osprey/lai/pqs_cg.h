...
typedef PQS_SET<TN *,lt_tn> PQS_TN_SET;
typedef PQS_SET<TN *,lt_tn>::set_type PQS_TN_SET_TYPE;
...
/*================================================================
  ...
  void PQSCG_init(BB * first_bb)
    ...
    Initialize everything. first_bb and its successors are walked using
    FOR_ALL_BBLIST_ITEMS and the internal data structures are built.
    If the PQS is already initialized, then nothing is done. 
...
extern BOOL PQSCG_is_disjoint(TN *tn1, TN *tn2);
...
/*================================================================
  ...
  ================================================================
*/
extern BOOL PQSCG_is_subset_of (TN *tn1, TN *tn2);
extern BOOL PQSCG_is_subset_of (TN *tn1, PQS_TN_SET &tns2);
...
/*================================================================
  ...
  instruction (when the predicate allows it).
...
extern BOOL PQSCG_sets_results_if_qual_true(OP *op);
