...
extern BOOL CGTARG_Check_Profitable_Select(CG_SCHED_EST *se1, CG_SCHED_EST *se2,int size_se1, int size_se2, float est_cost_before, float est_cost_after, float fallthr_prob, BOOL will_need_predicate_merge);
extern BOOL CGTARG_Check_Profitable_Logif(float cycles1, float est_cost_before, float select_factor, BB *bb1, BB *bb2);
