...
// Target specific function to decide whether or not to hoist a return instruction
// from the exit BB (target parameter) to the predecessor BB (src parameter)
extern BOOL CGTARG_Should_Hoist_Return(BB* src,BB* target);
