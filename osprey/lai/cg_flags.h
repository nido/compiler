...
CG_EXPORTED extern INT32 CG_LAO_schedkind;	/* LAO instruction scheduling algorithm */
CG_EXPORTED extern INT32 CG_LAO_schedtype;	/* LAO instruction scheduling type */
