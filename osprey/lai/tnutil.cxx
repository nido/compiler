...
/* ====================================================================
 *   Search_For_Previous_Symbol
 *
 *   search for a previously built constant LIT_TN 
 * ====================================================================
 */
static TN *
Search_For_Previous_Constant (
  INT64 ivalue, 
  INT size
)
{
 ...
 *   Gen_Literal_TN
 *
 *   Produce a literal TN with the given literal value and size, 
 *   either a pre-existing one or a newly created one.
 * ====================================================================
 */
TN *
Gen_Literal_TN ( 
...
)
{
  ...
  /* Check if there is already a constant TN with this value. 
