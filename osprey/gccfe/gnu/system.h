...
#undef calloc
#undef strdup
// [TB] workaround for use of poisoned malloc in gcc-3.3.3 STL
// distributon (<memory>) (see g++fr/gnu/system.h)
#if (GCC_VERSION >= 3005)
...
/*TB: to avoid  warning: poisoning existing macro "ASM_OPEN_PAREN" */
#if __GNUC__ < 3
 #pragma GCC poison ASM_OPEN_PAREN  ASM_CLOSE_PAREN FUNCTION_PROLOGUE FUNCTION_EPILOGUE EASY_DIV_EXPR ASM_IDENTIFY_GCC
#endif // __GNUC__ >= 3
...
/* Other obsolete target macros, or macros that used to be in target
 ...
 #pragma GCC poison INT_ASM_OP ASM_OUTPUT_EH_REGION_BEG			   \
	...
	OMIT_EH_TABLE  IMPLICIT_FIX_EXPR			   \
