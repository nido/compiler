...
extern rtx expand_simple_binop PARAMS ((machine_mode_t, enum rtx_code, rtx,
					rtx, rtx, int, enum optab_methods));
extern rtx expand_simple_unop PARAMS ((machine_mode_t, enum rtx_code,
				       rtx, rtx, int));

/* Report whether the machine description contains an insn which can
   perform the operation described by CODE and MODE.  */
extern int have_insn_for PARAMS ((enum rtx_code, machine_mode_t));
...
int can_conditionally_move_p PARAMS ((machine_mode_t mode));
...
/* Arguments MODE, RTX: return an rtx for the negation of that value.
   May emit insns.  */
extern rtx negate_rtx PARAMS ((machine_mode_t, rtx));

/* Expand a logical AND operation.  */
extern rtx expand_and PARAMS ((machine_mode_t, rtx, rtx, rtx));

/* Emit a store-flag operation.  */
extern rtx emit_store_flag PARAMS ((rtx, enum rtx_code, rtx, rtx,
				    machine_mode_t, int, int));
...
extern rtx expand_builtin PARAMS ((tree, rtx, rtx, machine_mode_t, int));
...
extern rtx convert_to_mode PARAMS ((machine_mode_t, rtx, int));

/* Convert an rtx to MODE from OLDMODE and return the result.  */
extern rtx convert_modes PARAMS ((machine_mode_t, machine_mode_t,
				  rtx, int));
...
extern void move_block_to_reg PARAMS ((int, rtx, int, machine_mode_t));
...
extern void emit_push_insn PARAMS ((rtx, machine_mode_t, tree, rtx,
...
extern rtx expand_expr PARAMS ((tree, rtx, machine_mode_t,
...
extern rtx expand_shift PARAMS ((enum tree_code, machine_mode_t, rtx, tree,
				 rtx, int));
extern rtx expand_divmod PARAMS ((int, enum tree_code, machine_mode_t, rtx,
				  rtx, rtx, int));
extern void locate_and_pad_parm PARAMS ((machine_mode_t, tree, int, tree,
					 struct args_size *,
					 struct args_size *,
					 struct args_size *,
					 struct args_size *));
...
extern rtx promoted_input_arg PARAMS ((unsigned int, machine_mode_t *,
				       int *));
...
extern rtx memory_address PARAMS ((machine_mode_t, rtx));

/* Like `memory_address' but pretent `flag_force_addr' is 0.  */
extern rtx memory_address_noforce PARAMS ((machine_mode_t, rtx));
...
extern rtx change_address PARAMS ((rtx, machine_mode_t, rtx));
...
extern rtx adjust_address_1 PARAMS ((rtx, machine_mode_t, HOST_WIDE_INT,
				     int, int));
extern rtx adjust_automodify_address_1 PARAMS ((rtx, machine_mode_t,
...
extern rtx widen_memory_access PARAMS ((rtx, machine_mode_t, HOST_WIDE_INT));
...
extern rtx copy_to_mode_reg PARAMS ((machine_mode_t, rtx));

/* Copy given rtx to given temp reg and return that.  */
extern rtx copy_to_suggested_reg PARAMS ((rtx, rtx, machine_mode_t));

/* Copy a value to a register if it isn't already a register.
   Args are mode (in case value is a constant) and the value.  */
extern rtx force_reg PARAMS ((machine_mode_t, rtx));
...
extern machine_mode_t promote_mode PARAMS ((tree, machine_mode_t,
					       int *, int));
#endif
...
/* Return an rtx that refers to the value returned by a library call
   in its original home.  This becomes invalid if any more code is emitted.  */
extern rtx hard_libcall_value PARAMS ((machine_mode_t));
...
extern machine_mode_t
mode_for_extraction PARAMS ((enum extraction_pattern, int));

extern rtx store_bit_field PARAMS ((rtx, unsigned HOST_WIDE_INT,
				    unsigned HOST_WIDE_INT,
				    machine_mode_t, rtx, HOST_WIDE_INT));
extern rtx extract_bit_field PARAMS ((rtx, unsigned HOST_WIDE_INT,
				      unsigned HOST_WIDE_INT, int, rtx,
				      machine_mode_t, machine_mode_t,
				      HOST_WIDE_INT));
extern rtx expand_mult PARAMS ((machine_mode_t, rtx, rtx, rtx, int));
extern bool const_mult_add_overflow_p PARAMS ((rtx, rtx, rtx, machine_mode_t, int));
extern rtx expand_mult_add PARAMS ((rtx, rtx, rtx, rtx,machine_mode_t, int));
extern rtx expand_mult_highpart_adjust PARAMS ((machine_mode_t, rtx, rtx, rtx, rtx, int));
...
extern void do_jump_by_parts_greater_rtx	PARAMS ((machine_mode_t,
							 int, rtx, rtx, rtx,
							 rtx));
...
extern int vector_mode_valid_p		PARAMS ((machine_mode_t));
