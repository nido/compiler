...
extern int    arm_split_constant	PARAMS ((RTX_CODE, machine_mode_t,
						HOST_WIDE_INT, rtx, rtx, int));
extern RTX_CODE arm_canonicalize_comparison PARAMS ((RTX_CODE, rtx *));
extern int    legitimate_pic_operand_p	PARAMS ((rtx));
extern rtx    legitimize_pic_address	PARAMS ((rtx, machine_mode_t, rtx));
...
extern int    power_of_two_operand	PARAMS ((rtx, machine_mode_t));
...
extern machine_mode_t arm_select_cc_mode PARAMS ((RTX_CODE, rtx, rtx));
...
extern int    arm_go_if_legitimate_address PARAMS ((machine_mode_t, rtx));
