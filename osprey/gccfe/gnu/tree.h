...
#define TREE_STRING_LENGTH(NODE) (STRING_CST_CHECK (NODE)->string.length)
     ...
     /* (cbr) exported to g++fe  */
#define TREE_STRING_POINTER(NODE) ((char*)STRING_CST_CHECK (NODE)->string.pointer)
#else
...
#ifdef TARG_ST
#define DECL_DST_IDX(NODE) (DECL_CHECK(NODE)->decl.decl_dst_id)
#else
...
#ifdef TARG_ST // [CL] support for noinline and always_inline attributes
#define DECL_ALWAYS_INLINE(NODE) (FUNCTION_DECL_CHECK (NODE)->decl.always_inline)
#endif
...
#ifdef TARG_ST
  // [CL] support for noinline and always_inline attributes
