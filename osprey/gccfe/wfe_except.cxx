...
static std::vector<EH_INFO> eh_info_stack;
static std::vector<EH_INFO> catch_stack;
static std::vector<LABEL_IDX> caught_return_label_stack;
static std::queue <EH_INFO> eh_info_queue;
