...
{
  enum rtx_code code;
  struct optab_handlers handlers[MAX_LIMIT_MACHINE_MODE];
};
...
{
  enum rtx_code code;
  struct optab_handlers handlers[MAX_LIMIT_MACHINE_MODE][MAX_LIMIT_MACHINE_MODE];
};
...
extern enum insn_code vcond_gen_code[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code vcondu_gen_code[MAX_LIMIT_MACHINE_MODE];

/* This array records the insn_code of insns to perform block moves.  */
extern enum insn_code movmem_optab[MAX_LIMIT_MACHINE_MODE];

/* This array records the insn_code of insns to perform block sets.  */
extern enum insn_code setmem_optab[MAX_LIMIT_MACHINE_MODE];

/* These arrays record the insn_code of two different kinds of insns
   to perform block compares.  */
extern enum insn_code cmpstr_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code cmpstrn_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code cmpmem_optab[MAX_LIMIT_MACHINE_MODE];

/* Synchronization primitives.  This first set is atomic operation for
   which we don't care about the resulting value.  */
extern enum insn_code sync_add_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_sub_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_ior_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_and_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_xor_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_nand_optab[MAX_LIMIT_MACHINE_MODE];

/* This second set is atomic operations in which we return the value
   that existed in memory before the operation.  */
extern enum insn_code sync_old_add_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_old_sub_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_old_ior_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_old_and_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_old_xor_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_old_nand_optab[MAX_LIMIT_MACHINE_MODE];

/* This third set is atomic operations in which we return the value
   that resulted after performing the operation.  */
extern enum insn_code sync_new_add_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_new_sub_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_new_ior_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_new_and_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_new_xor_optab[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_new_nand_optab[MAX_LIMIT_MACHINE_MODE];

/* Atomic compare and swap.  */
extern enum insn_code sync_compare_and_swap[MAX_LIMIT_MACHINE_MODE];
extern enum insn_code sync_compare_and_swap_cc[MAX_LIMIT_MACHINE_MODE];

/* Atomic exchange with acquire semantics.  */
extern enum insn_code sync_lock_test_and_set[MAX_LIMIT_MACHINE_MODE];

/* Atomic clear with release semantics.  */
extern enum insn_code sync_lock_release[MAX_LIMIT_MACHINE_MODE];
