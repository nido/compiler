...
tree_expand_cfg (void)
{
  ...
  /* [SC] Run the expansion to gimple, since there are further "front-end" errors
     that may be reported.  The specific case that motivates this is expansion
     of __builtin_va_list, which may report that we are not in a variadic
     function. */
