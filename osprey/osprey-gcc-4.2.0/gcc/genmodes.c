...
#ifdef TARG_ST
  puts ("  STATIC_COUNT_MACHINE_MODE,\n");
#else
...
emit_mode_name (void)
{
  ...
  print_decl ("char *", "mode_name", "MAX_LIMIT_MACHINE_MODE");
...
emit_mode_class (void)
{
  ...
  print_decl ("unsigned char", "mode_class", "MAX_LIMIT_MACHINE_MODE");
...
emit_mode_precision (void)
{
  ...
  print_decl ("unsigned short", "mode_precision", "MAX_LIMIT_MACHINE_MODE");
...
emit_mode_size (void)
{
  ...
  print_maybe_const_decl ("%sunsigned short", "mode_size",
			  "MAX_LIMIT_MACHINE_MODE", bytesize);
#else
...
emit_mode_nunits (void)
{
  ...
  print_decl ("unsigned char", "mode_nunits", "MAX_LIMIT_MACHINE_MODE");
...
emit_mode_wider (void)
{
  ...
  print_decl ("unsigned char", "mode_wider", "MAX_LIMIT_MACHINE_MODE");
  ...
  print_closer ();
  print_decl ("unsigned char", "mode_2xwider", "MAX_LIMIT_MACHINE_MODE");
...
emit_mode_inner (void)
{
  ...
  print_decl ("unsigned char", "mode_inner", "MAX_LIMIT_MACHINE_MODE");
...
emit_mode_base_align (void)
{
  ...
  print_maybe_const_decl ("%sunsigned char",
			  "mode_base_align", "MAX_LIMIT_MACHINE_MODE",
			  alignment);
