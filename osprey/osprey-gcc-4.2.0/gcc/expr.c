...
enum insn_code movmem_optab[MAX_LIMIT_MACHINE_MODE];

/* This array records the insn_code of insns to perform block sets.  */
enum insn_code setmem_optab[MAX_LIMIT_MACHINE_MODE];

/* These arrays record the insn_code of three different kinds of insns
   to perform block compares.  */
enum insn_code cmpstr_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code cmpstrn_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code cmpmem_optab[MAX_LIMIT_MACHINE_MODE];

/* Synchronization primitives.  */
enum insn_code sync_add_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_sub_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_ior_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_and_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_xor_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_nand_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_old_add_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_old_sub_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_old_ior_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_old_and_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_old_xor_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_old_nand_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_new_add_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_new_sub_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_new_ior_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_new_and_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_new_xor_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_new_nand_optab[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_compare_and_swap[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_compare_and_swap_cc[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_lock_test_and_set[MAX_LIMIT_MACHINE_MODE];
enum insn_code sync_lock_release[MAX_LIMIT_MACHINE_MODE];
...
{
  gcc_assert (REG_P (reg) && REGNO (reg) < FIRST_PSEUDO_REGISTER_USED);
...
use_regs (rtx *call_fusage, int regno, int nregs)
{
  ...
  gcc_assert (regno + nregs <= FIRST_PSEUDO_REGISTER_USED);
