...
static bool sdiv_pow2_cheap[MAX_LIMIT_MACHINE_MODE];
static bool smod_pow2_cheap[MAX_LIMIT_MACHINE_MODE];
...
static int add_cost[MAX_LIMIT_MACHINE_MODE];
static int neg_cost[MAX_LIMIT_MACHINE_MODE];
static int shift_cost[MAX_LIMIT_MACHINE_MODE][MAX_BITS_PER_WORD];
static int shiftadd_cost[MAX_LIMIT_MACHINE_MODE][MAX_BITS_PER_WORD];
static int shiftsub_cost[MAX_LIMIT_MACHINE_MODE][MAX_BITS_PER_WORD];
static int mul_cost[MAX_LIMIT_MACHINE_MODE];
static int sdiv_cost[MAX_LIMIT_MACHINE_MODE];
static int udiv_cost[MAX_LIMIT_MACHINE_MODE];
