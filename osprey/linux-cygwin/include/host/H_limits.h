...
/* JZ : we continue to use this version of limits.h as it was originally 
   done in the pro64 distribution... cleanup nevertheless required ! */
...
#include <limits.h>		/* recurse down to the real one */
#endif
